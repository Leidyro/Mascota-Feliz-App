    ...
    public class RepositorioMascota : IRepositorioMascota
    {
        ...
        Mascota IRepositorioMascota.UpdateMascota(Mascota mascota, int idMascota_original)
        {
            ...
            if (mascotaEncontrado==null)
            {
                ...
                mascotaEncontrado.FrecuenciaRespiratoria=mascota.FrecuenciaRespiratoria;
                mascotaEncontrado.FrecuenciaCardiaca =mascota.FrecuenciaCardiaca;
                mascotaEncontrado.EstadoDeAnimo=mascota.EstadoDeAnimo;
